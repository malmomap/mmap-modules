...
--------------------
A dialogbox with information will appear when a spatialsuite map is loaded. This information can be adjusted by administrators and there is also a do not show again feature. Different maps can have define different texts. Also possible to have seperate warning and info pop-ups. test
